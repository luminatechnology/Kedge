...
namespace Kedge.DAC
{
    ...
    public class KGDeductionAPTran : IBqlTable, PX.Objects.DR.Descriptor.IDocumentLine, ISortOrder, ITaxableDetail, IAccountable
    {
        #region Selected
        ...
        [PXParent(typeof(Select<APRegister, Where<APRegister.docType, Equal<Current<KGDeductionAPTran.tranType>>, And<APRegister.refNbr, Equal<Current<KGDeductionAPTran.refNbr>>>>>))]
        ...
        [PXDBInt]
        [PXUIField(DisplayName = KGDeductionAPTran.sortOrder.DispalyName, Visible = false, Enabled = false)]
        ...
        [PXSelector(typeof(Search<POOrder.orderNbr, Where<POOrder.orderType, Equal<Optional<KGDeductionAPTran.pOOrderType>>>>))]
        ...
        public abstract class pOLineNbr : PX.Data.BQL.BqlInt.Field<pOLineNbr>
        {
            public class PreventEditAccrualAcctIfAPTranExists : PreventEditOf<POLine.pOAccrualAcctID, POLine.pOAccrualSubID>.On<POOrderEntry>
                .IfExists<Select<KGDeductionAPTran,
                    Where<KGDeductionAPTran.pOOrderType, Equal<Current<POLine.orderType>>,
                        And<KGDeductionAPTran.pONbr, Equal<Current<POLine.orderNbr>>,
                        And<KGDeductionAPTran.pOLineNbr, Equal<Current<POLine.lineNbr>>>>>>>
            {
                ...
                {
                    var tran = (KGDeductionAPTran)t;
                    var docTypeDict = new APDocType.ListAttribute().ValueLabelDic;
                    return PXMessages.LocalizeFormat(PX.Objects.PO.Messages.AccrualAcctUsedInAPBill, docTypeDict[tran.TranType], tran.RefNbr);
                }
            }
        }
        ...
        /// </value>
        [PXDBInt()]
        [PXParent(typeof(Select<POLandedCostDetail, Where<POLandedCostDetail.docType, Equal<Current<KGDeductionAPTran.lCDocType>>,
                                                    And<POLandedCostDetail.refNbr, Equal<Current<KGDeductionAPTran.lCRefNbr>>,
                                                    And<POLandedCostDetail.lineNbr, Equal<Current<KGDeductionAPTran.lCRefNbr>>>>>>))]
        ...
        /// </value>
        [Account(typeof(KGDeductionAPTran.branchID), DisplayName = "Account", Visibility = PXUIVisibility.Visible, Filterable = false, DescriptionField = typeof(Account.description))]
        [PXDefault(typeof(Search<InventoryItem.cOGSAcctID, Where<InventoryItem.inventoryID, Equal<Current<KGDeductionAPTran.inventoryID>>>>))]
        ...
        /// </value>
        [SubAccount(typeof(KGDeductionAPTran.accountID), typeof(KGDeductionAPTran.branchID), true, DisplayName = "Subaccount", Visibility = PXUIVisibility.Visible, Filterable = true)]
        [PXDefault(typeof(Search<InventoryItem.cOGSSubID, Where<InventoryItem.inventoryID, Equal<Current<KGDeductionAPTran.inventoryID>>>>))]
        ...
        /// </value>
        [ProjectDefault(BatchModule.AP, typeof(Search<Location.vDefProjectID, Where<Location.bAccountID, Equal<Current<APInvoice.vendorID>>, And<Location.locationID, Equal<Current<APInvoice.vendorLocationID>>>>>), typeof(KGDeductionAPTran.accountID))]
        ...
        [ActiveProjectTask(typeof(KGDeductionAPTran.projectID), BatchModule.AP, DisplayName = "Project Task")]
        ...
        [CostCode(typeof(accountID), typeof(taskID), PX.Objects.GL.AccountType.Expense, ReleasedField = typeof(released),
        ...
        [PXDefault(typeof(Coalesce<Search<Account.box1099, Where<Account.accountID, Equal<Current<KGDeductionAPTran.accountID>>>>, Search<Vendor.box1099, Where<Vendor.bAccountID, Equal<Current<KGDeductionAPTran.vendorID>>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        /// </value>
		[PXDefault(typeof(Search<InventoryItem.purchaseUnit, Where<InventoryItem.inventoryID, Equal<Current<KGDeductionAPTran.inventoryID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
        [INUnit(typeof(KGDeductionAPTran.inventoryID))]
        ...
        [PXUIField(DisplayName = "Quantity", Visibility = PXUIVisibility.Visible,Enabled =false)]
        ...
        /// </summary>
		[PXDBCurrency(typeof(Search<CommonSetup.decPlPrcCst>), typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.unitCost))]
        ...
        /// </summary>
		[PXDBPriceCost()]
        [PXDefault(typeof(Search<INItemCost.lastCost, Where<INItemCost.inventoryID, Equal<Current<KGDeductionAPTran.inventoryID>>>>))]
        ...
        /// (Presented in the currency of the document, see <see cref="APRegister.CuryID"/>)
        /// </summary>
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.lineAmt))]
        [PXUIField(DisplayName = "Ext. Cost", Enabled = false)]
        [PXFormula(typeof(Mult<KGDeductionAPTran.qty, KGDeductionAPTran.curyUnitCost>))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        /// </summary>
        [ManualDiscountMode(typeof(KGDeductionAPTran.curyDiscAmt), typeof(KGDeductionAPTran.curyTranAmt), typeof(KGDeductionAPTran.discPct), typeof(KGDeductionAPTran.freezeManualDisc), DiscountFeatureType.VendorDiscount)]
        [PXDBBool()]
        [PXDefault(false)]
        ...
        /// (Presented in the currency of the document, see <see cref="APRegister.CuryID"/>)
        /// </summary>
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.discAmt))]
        ...
        /// (Presented in the currency of the document, see <see cref="APRegister.CuryID"/>)
        /// </summary>
        [PXDBPriceCostCalced(typeof(Switch<Case<Where<KGDeductionAPTran.qty, Equal<decimal0>>, decimal0>, Div<KGDeductionAPTran.curyTranAmt, KGDeductionAPTran.qty>>), typeof(Decimal), CastToScale = 9, CastToPrecision = 25)]
        [PXFormula(typeof(Div<KGDeductionAPTran.curyTranAmt, NullIf<KGDeductionAPTran.qty, decimal0>>))]
        [PXCurrency(typeof(Search<CommonSetup.decPlPrcCst>), typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.discCost))]
        ...
        /// (Presented in the base currency of the company, see <see cref="Company.BaseCuryID"/>)
        /// </summary>
        [PXDBPriceCostCalced(typeof(Switch<Case<Where<KGDeductionAPTran.qty, Equal<decimal0>>, decimal0>, Div<KGDeductionAPTran.lineAmt, KGDeductionAPTran.qty>>), typeof(Decimal), CastToScale = 9, CastToPrecision = 25)]
        [PXFormula(typeof(Div<Row<KGDeductionAPTran.lineAmt, KGDeductionAPTran.curyLineAmt>, NullIf<KGDeductionAPTran.qty, decimal0>>))]
        ...
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.retainageAmt))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXUIField(Visibility = PXUIVisibility.Invisible)]
        ...
        /// (Presented in the currency of the document, see <see cref="APRegister.CuryID"/>)
        /// </summary>
		[PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.tranAmt))]
        [PXUIField(DisplayName = "Amount", Visibility = PXUIVisibility.SelectorVisible, Enabled = false)]
        [PXFormula(typeof(Sub<KGDeductionAPTran.curyLineAmt, Add<KGDeductionAPTran.curyDiscAmt, KGDeductionAPTran.curyRetainageAmt>>))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        /// (Presented in the currency of the document, see <see cref="APRegister.CuryID"/>)
        /// </summary>
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.taxableAmt))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        /// (Presented in the currency of the document, see <see cref="APRegister.CuryID"/>)
        /// </summary>
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.taxAmt))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        /// (Presented in the currency of the document, see <see cref="APRegister.CuryID"/>)
        /// </summary>
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.retainedTaxableAmt), BaseCalc = false)]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        /// (Presented in the currency of the document, see <see cref="APRegister.CuryID"/>)
        /// </summary>
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.retainedTaxAmt), BaseCalc = false)]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.cashDiscBal), BaseCalc = false)]
        ...
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.origRetainageAmt))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.retainageBal), BaseCalc = false)]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.origTranAmt), BaseCalc = false)]
        ...
        [PXDBCurrency(typeof(KGDeductionAPTran.curyInfoID), typeof(KGDeductionAPTran.tranBal), BaseCalc = false)]
        ...
        [PXUIField(DisplayName = PX.Objects.Common.Messages.DocumentDate, Visible = false)]
        ...
        /// </value>
		[FinPeriodID(
            branchSourceType: typeof(KGDeductionAPTran.branchID),
            masterFinPeriodIDType: typeof(KGDeductionAPTran.tranPeriodID),
        ...
        [PXSelector(typeof(Search<PX.Objects.IN.INRegister.refNbr, Where<PX.Objects.IN.INRegister.docType, Equal<Optional<KGDeductionAPTran.pPVDocType>>>, OrderBy<Desc<PX.Objects.IN.INRegister.refNbr>>>), Filterable = true)]
        ...
        [PXSelector(
            typeof(Search<PX.Objects.DR.DRSchedule.scheduleID,
                Where<PX.Objects.DR.DRSchedule.bAccountID, Equal<Current<APInvoice.vendorID>>,
                    And<PX.Objects.DR.DRSchedule.docType, Equal<APInvoiceType.invoice>,
                        Or<PX.Objects.DR.DRSchedule.docType, Equal<APInvoiceType.creditAdj>>>>>),
        ...
        /// </summary>
        [PXDBDate]
        [PXUIField(DisplayName = PX.Objects.Common.Messages.ExpenseDate)]
        ...
        [PXSelector(typeof(Search<PX.Objects.PO.LandedCostCode.landedCostCodeID>))]
            ...
            Where<APDiscount.type, Equal<DiscountType.LineDiscount>,
                And<
                    ...
                    Or2<
                        ...
                        And<APDiscount.bAccountID, Equal<Current<KGDeductionAPTran.vendorID>>>>>>>>>))]
        ...
        [PXDefault(typeof(Search<InventoryItem.taxCategoryID,
            Where<InventoryItem.inventoryID, Equal<Current<KGDeductionAPTran.inventoryID>>>>),
        ...
        public decimal Sign
        {
            get { return this.DrCr == PX.Objects.GL.DrCr.Debit ? Decimal.One : Decimal.MinusOne; }
        }
        #endregion
        #region SignedQty
        ...
        string PX.Objects.DR.Descriptor.IDocumentLine.Module => BatchModule.AP;
    ...
    public abstract class valuationID : IBqlField { }
        ...
        #region ReverseRefNbr
    public abstract class reverseRefNbr : PX.Data.IBqlField
    {
    }
    protected String _ReverseRefNbr;

    [PXDBString(15, IsUnicode = true)]
    [PXUIField(DisplayName = "Revese Reference Nbr.")]
        
    public virtual String ReverseRefNbr
    {
        get
        {
            return this._ReverseRefNbr;
        }
        set
        {
            this._ReverseRefNbr = value;
        }
    }
        #endregion

        #region ManualDisc
        public abstract class isManageFee : PX.Data.BQL.BqlBool.Field<isManageFee>
        {
        }
        protected Boolean? _IsManageFee;
        [PXDBBool()]
        [PXDefault(false,PersistingCheck =PXPersistingCheck.Nothing)]
        [PXUIField(DisplayName = "Is Manage Fee", Visibility = PXUIVisibility.Visible, Visible = false)]
        public virtual Boolean? IsManageFee
        {
            get
            {
                return this._IsManageFee;
            }
            set
            {
                this._IsManageFee = value;
            }
        }
        #endregion
    ...
    public class APLineType
    {
        ...
        public const string Discount = PX.Objects.SO.SOLineType.Discount;
