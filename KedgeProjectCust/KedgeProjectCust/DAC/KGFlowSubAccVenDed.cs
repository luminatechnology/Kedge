...
{
      [Serializable]
      public class KGFlowSubAccVenDed : IBqlTable
      {
        #region Setup
        ...
        #region NoManagefareDesc
        [PXDBString(400, IsUnicode = true, InputMask = "")]
        [PXUIField(DisplayName = "No Managefare Desc")]
        public virtual string NoManagefareDesc { get; set; }
        public abstract class noManagefareDesc : PX.Data.BQL.BqlString.Field<noManagefareDesc> { }
        #endregion

        #region Managefare
        [PXDBDecimal()]
        [PXUIField(DisplayName = "Managefare")]
        [PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
        public virtual Decimal? Managefare { get; set; }
        public abstract class managefare : PX.Data.BQL.BqlDecimal.Field<managefare> { }
        #endregion

        #region ManagefarTax
        [PXDBDecimal()]
        [PXUIField(DisplayName = "Managefar Tax")]
        [PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
        public virtual Decimal? ManagefarTax { get; set; }
        public abstract class managefarTax : PX.Data.BQL.BqlDecimal.Field<managefarTax> { }
        #endregion
