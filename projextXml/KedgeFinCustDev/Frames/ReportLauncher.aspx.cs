...
public partial class Pages_ReportLauncher : PX.Web.UI.PXPage
{
	...
	static Pages_ReportLauncher()
	{
        ...
        var weatherIntegrationUnitOfMeasureService = System.Web.Compilation.BuildManager
            .GetType("ProjectManagement.WeatherIntegrationUnitOfMeasureService", false);
        if (weatherIntegrationUnitOfMeasureService != null)
        {
            ExpressionContext.RegisterExternalObject("WeatherIntegrationUnitOfMeasureService",
                Activator.CreateInstance(weatherIntegrationUnitOfMeasureService));
        }
		
		///<remarks> The following modification is only for LS6100000 report</remarks>
		Type DemoReportFunctionsType = System.Web.Compilation.BuildManager.GetType("ReportUDF.UtilFunctions", false);
